...
> **Figma 변환 제약 안내**
> 브라우저(WebKit)와 Figma의 텍스트·자간 계산 방식 차이, 임의적인 CSS 표현 제약으로 인해 한 번에 완벽한 1대1 변환이 어려울 수 있어요.
> 이 경우 개별 페이지 스크린샷을 Claude Code에 첨부하면 수정을 도와줍니다.

- (🖼️ 제가 직접 발표를 준비하며 만든 데모 PPT들이 뽀나리~ 들이 포함되어있습니다)
